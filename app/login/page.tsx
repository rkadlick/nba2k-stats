      ...
      <div className="max-w-md w-full bg-[color:var(--color-surface)] border border-[color:var(--color-border)] rounded-xl shadow-lg p-8 transition-colors">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="btn-primary w-full py-3 font-semibold rounded-lg focus:outline-none focus:ring-2 focus:ring-[color:var(--color-focus)] focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
